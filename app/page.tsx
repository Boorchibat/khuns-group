...
import { KhunsIntro } from "./components/KhunsIntro";
          ...
          <div className="relative z-10 flex h-full items-center justify-center text-center text-white px-6 sm:px-10 lg:px-[100px]">
            ...
            >
              ...
              <p className="mt-4 text-sm sm:text-base md:text-lg lg:text-xl text-white/80 px-4">
                Leading meat production company in Mongolia delivering quality
                to the world.
              </p>
            </motion.div>
          </div>
          ...
          <div className="max-full flex flex-col mt-16 md:mt-24 lg:mt-32 mx-2 sm:mx-8">
            ...
            >
              <h1 className="text-white font-bold text-lg sm:text-xl px-6 sm:px-10 pt-8 sm:pt-10 w-full sm:w-[80%] lg:w-[70%]">
                Khuns Group is one of Mongolias leading food production
                companies, committed to delivering high-quality, safe, and
                nutritious products that support the well-being of families
                across the country.
              </h1>
              <h1 className="text-gray-300 font-medium px-6 sm:px-10 py-8 sm:py-10">
                ...
                excellence, we combine modern production standards with decades
                of industry expertise to provide trusted food solutions. By
